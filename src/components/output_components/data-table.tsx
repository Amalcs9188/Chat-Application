...
export function DataTable<TData, TValue>({
  ...
  const searchTerm = paginationStore((state) => state.searchTerm);
          ...
          <div className="relative my-2 flex gap-3 items-center w-1/2">
            ...
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-10 rounded-2xl border-bg-primary dark:border-input dark:bg-sidebar shadow-none placeholder:text-[#8C8C8C]"
              />
            </div>
          </div>
        ...
        <div className="flex-1">
                    ...
                    <TableRow key={headerGroup.id}>
                      {headerGroup.headers.map((header) => {
                        return (
                          <TableHead
                            key={header.id}
                            className="text-left whitespace-nowrap px-6 bg-datatable-foreground text-datatable-headingColor font-semibold">
          ...
          <div className="flex items-center justify-end space-x-2 pt-4">
            <div className="flex-1 text-sm text-[#595959] ml-2">
              ...
              Showing {(offset || 0) + 1}-
              {Math.min((offset || 0) + (limit || 0), totalCount || 0)} of{" "}
              {totalCount || 0} row(s)
            </div>
            {/* <select
          ...
          {[10, 20, 30, 40, 50].map((size) => (
            ...
            <Button
              ...
              disabled={
                pageIndex >= Math.ceil((totalCount || 0) / pageSize) - 1
              }>
              Next
            </Button>
          </div>
